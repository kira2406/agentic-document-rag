...
def grade_generation_grounded_documents_and_question(state: GraphState) -> str:
    ...
    if hallucination_result := score.binary_score:
...
workflow.add_conditional_edges(
    GENERATE,
    grade_generation_grounded_documents_and_question,
    {
        "useful": END,
